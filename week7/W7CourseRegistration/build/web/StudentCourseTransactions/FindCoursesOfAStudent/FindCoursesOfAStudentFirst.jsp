<%-- 
    Document   : FindCoursesOfAStudentFirst
    Author     : Melike Geçer
--%>
...
<html>
    <head>
        ...
        <title>Find Courses Of A Student</title>
    </head>
    <body>
        ...
        <form action="courseRegistration" method="post">
            <hr><ol>
                ...
                %>
                <select name="Select A Student To Show">
                    <%
                ...
                <input type="submit" name="action" value="Find The Courses Of A Student" >
            </ol><hr>
