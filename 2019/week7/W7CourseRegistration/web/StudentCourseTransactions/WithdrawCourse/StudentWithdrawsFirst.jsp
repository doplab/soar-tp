<%-- 
    Document   : StudentWithdrawsFirst
    Author     : Melike Geçer
--%>
...
<html>
    <head>
        ...
        <title>Student Withdraws From A Course</title>
    </head>
    <body>
        ...
        <form action="courseRegistration" method="post">
            <hr><ol>
                ...
                %>
                <select name="Select A Student To Withdraw A Course">
                    <%
                ...
                %>
                <select name="Select A Course Name To Withdraw">
                    <%
            ...
            <input type="submit" name="action" value="Student Withdraws From The Course">
        </form>
